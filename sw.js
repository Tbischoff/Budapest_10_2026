const CACHE_NAME = "budapest-travel-v1.22.13";
const OFFLINE_MAP_CACHE = "budapest-offline-map-v1";
const APP_SHELL = ["./","./index.html","./assets/css/style.css?v=1.22.13","./assets/js/app.js?v=1.22.13","./data/places.js","./assets/icons/favicon.svg","./manifest.webmanifest?v=1.22.13",
